     ...
     0xa0, 0xe0, 0x3b, 0x4d, 0xae, 0x2a, 0xf5, 0xb0, 0xc8, 0xeb, 0xbb, 0x3c, 0x83, 0x53, 0x99, 0x61,
      0x17, 0x2b, 0x04, 0x7e, 0xba, 0x77, 0xd6, 0x26, 0xe1, 0x69, 0x14, 0x63, 0x55, 0x21, 0x0c, 0x7d };
        ...
        private void inverseMixedColumns(int blockSize , ref byte[,] mat)
        {
            ...
            for (int col = 0; col < 4; col++)
            {
                mat[0, col] = (byte)((int)mixColumsMulBy0e(cMatrixFromMain[0, col]) ^ (int)mixColumsMulBy0b(cMatrixFromMain[1, col]) ^ (int)mixColumsMulBy0d(cMatrixFromMain[2, col]) ^ (int)mixColumsMulBy09(cMatrixFromMain[3, col]));
                mat[1, col] = (byte)((int)mixColumsMulBy09(cMatrixFromMain[0, col]) ^ (int)mixColumsMulBy0e(cMatrixFromMain[1, col]) ^ (int)mixColumsMulBy0b(cMatrixFromMain[2, col]) ^ (int)mixColumsMulBy0d(cMatrixFromMain[3, col]));
                mat[2, col] = (byte)((int)mixColumsMulBy0d(cMatrixFromMain[0, col]) ^ (int)mixColumsMulBy09(cMatrixFromMain[1, col]) ^ (int)mixColumsMulBy0e(cMatrixFromMain[2, col]) ^ (int)mixColumsMulBy0b(cMatrixFromMain[3, col]));
                mat[3, col] = (byte)((int)mixColumsMulBy0b(cMatrixFromMain[0, col]) ^ (int)mixColumsMulBy0d(cMatrixFromMain[1, col]) ^ (int)mixColumsMulBy09(cMatrixFromMain[2, col]) ^ (int)mixColumsMulBy0e(cMatrixFromMain[3, col]));
            }
        }
